...
## Web UI for Simple Scheduler

If you're using Sidekiq's web UI, you can manage Simple Scheduler's future jobs using
the web interface. Add `require "simple_scheduler/web"` after `require "sidekiq/web"`.
...
>>>>>>> Initial commit for adding Sidekiq Web UI
## Contributing
